...
public class SSLManager implements HostnameVerifier {
	...
	static TrustManager[] trustAllCerts = new TrustManager[] { new X509TrustManager() {
		public java.security.cert.X509Certificate[] getAcceptedIssuers() {
			Logging.debug("getAcceptedIssuers");
			return new X509Certificate[0];
		}

		public void checkClientTrusted(java.security.cert.X509Certificate[] certs, String authType) {
			Logging.debug("checkClientTrusted");
		}

		public void checkServerTrusted(java.security.cert.X509Certificate[] certs, String authType) {
			Logging.debug("checkServerTrusted");
		}
	} };
	...
	public boolean verify(String hostname, SSLSession session) {
		...
		Logging.debug("*** Hostname always VERIFIED ***" + hostname + " SSLSession: " + session);
	...
	public SSLContext getSSLContextFromJKS(String jksName, String jksPassword) {
		...
		try {
			...
			Logging.error("getSSLContextFromJKS jksName:"+jksName+" jksPassword:"+jksPassword+" error:"+e.getMessage());
