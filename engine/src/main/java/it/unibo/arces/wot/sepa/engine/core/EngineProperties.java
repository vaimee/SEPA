...
public class EngineProperties {
	...
	public EngineProperties(String propertiesFile,Optional<Boolean> secure) throws SEPAPropertiesException {
		...
		result.parameters.gates.security.enabled = (secure.isEmpty() ? false : secure.get());
	}
