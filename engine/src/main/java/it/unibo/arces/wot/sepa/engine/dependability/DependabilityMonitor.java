...
//		return AuthorizationManagerBeans.getTokenExpiringPeriod(null);
//	}
//
//	@Override
//	public void setTokenExpiringPeriod(long period) {
//		AuthorizationManagerBeans.setTokenExpiringPeriod(null,period);
//	}
//
//	@Override
//	public void addAuthorizedIdentity(String id) {
//		AuthorizationManagerBeans.getAuthorizedIdentities().add(id);
//	}
//
//	@Override
