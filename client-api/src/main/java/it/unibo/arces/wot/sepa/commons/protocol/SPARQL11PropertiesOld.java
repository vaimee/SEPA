...
public class SPARQL11PropertiesOld {
	/**
	...
	public SPARQL11PropertiesOld(String propertiesFile) throws SEPAPropertiesException {
		this(propertiesFile, true);
	}

	public SPARQL11PropertiesOld(String propertiesFile, boolean validate) throws SEPAPropertiesException {
		loadProperties(propertiesFile, validate);
	}

	public SPARQL11PropertiesOld() throws SEPAPropertiesException {
		loadProperties(null, false);
	}

	protected void loadProperties(String jsapFile, boolean val) throws SEPAPropertiesException {
	...
	protected void defaults() {
		...
		else sparql11protocol.add("port", new JsonPrimitive(8000));

		JsonObject query = new JsonObject();
		if (env.get("query-path")!= null) query.addProperty("path", (env.get("query-path")));		
		else query.add("path", new JsonPrimitive("/query"));
		...
		else update.add("path", new JsonPrimitive("/update"));
